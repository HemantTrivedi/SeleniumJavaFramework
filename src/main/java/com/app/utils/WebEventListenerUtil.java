...
public class WebEventListenerUtil implements WebDriverListener {
    ...
    public void beforeSendKeys(WebElement element, CharSequence... keysToSend) {
        System.out.println("Sending keys: " + String.join("", keysToSend) + " to element: " + element.toString());
    }

    @Override
    public void afterSendKeys(WebElement element, CharSequence... keysToSend) {
        System.out.println("Sent keys: " + String.join("", keysToSend) + " to element: " + element.toString());
    }
